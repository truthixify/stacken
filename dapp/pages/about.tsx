    ...
    <Layout title="About - Stacken Rewards">
      ...
      <section className="gradient-bg text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">About Stacken Rewards</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 mb-8">
              ...
              decentralized platform where creators can build engaging reward campaigns, distribute
              meaningful incentives, and foster stronger connections with their communities.
            </p>
            <p className="text-lg text-gray-600">
              Built on the Stacks blockchain, we combine the security and transparency of Bitcoin
              with the flexibility of smart contracts to create a truly decentralized rewards
              ecosystem.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Set up your reward campaign with custom activities, point values, and distribution
                rules
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Automatic or manual distribution of tokens, points, or custom rewards to
                participants
              </p>
            </div>
          </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Stacken Rewards is an open-source project built by developers who believe in the power
              of decentralized communities and fair reward distribution.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Our code is open source and available on GitHub. We welcome contributions, feedback,
              and collaboration from the Stacks community.
            </p>
