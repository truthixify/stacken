...
const ProfilePage: NextPage = () => {
    ...
    return (
        <Layout title={`${profile.displayName || profile.username || truncateAddress(profile.stacksAddress)} - Profile`}>
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                {/* Profile Header */}
                <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-6">
                    <div className="flex items-start justify-between">
                        <div className="flex items-center space-x-4">
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-gray-500 text-sm mb-2">{truncateAddress(profile.stacksAddress)}</p>
                                {profile.bio && (
                                    <p className="text-gray-700 whitespace-pre-wrap mb-3">{profile.bio}</p>
                                )}
                    ...
                    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                ...
                                <p className="text-2xl font-bold text-gray-900">{profile.stats?.totalPoints || profile.totalPoints || 0}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                ...
                                <p className="text-2xl font-bold text-gray-900">{profile.stats?.totalCampaignsParticipated || 0}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                ...
                                <p className="text-2xl font-bold text-gray-900">{profile.stats?.totalCampaignsCreated || 0}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                        <div className="flex items-center">
                            ...
                            <div className="ml-4">
                                ...
                                <p className="text-2xl font-bold text-gray-900">{profile.stats?.totalSubmissions || 0}</p>
                            </div>
                        </div>
                    </div>
                </div>
