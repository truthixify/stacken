...
const EditCampaign: NextPage = () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        reset({
          ...
          tokenAmount: campaign.tokenAmount || 0,
  ...
  const onSubmit = async (data: CampaignFormData) => {
    ...
    try {
      ...
      toast.loading('Updating campaign...', { id: loadingToast });
      const campaignData = {
        ...data,
        tags,
        taskLinks,
      ...
      if (response.ok) {
        ...
        toast.error(error.message || 'Failed to update campaign', { id: loadingToast });
      }
    } catch (error) {
      console.error('Error updating campaign:', error);
      toast.error('Failed to update campaign. Please try again.', { id: loadingToast });
    } finally {
      setLoading(false);
    }
  };
