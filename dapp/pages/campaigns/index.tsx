      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
          <div>
            ...
            <p className="text-gray-600">Discover and join reward campaigns from the community</p>
          </div>
          {isSignedIn && (
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-6">Try adjusting your search criteria or create a new campaign.</p>
            {isSignedIn && (
              <Link href="/campaigns/create">
