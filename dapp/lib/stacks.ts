...
export const createCampaign = async (
    ...
    const txOptions = {
        ...
        functionArgs: [
            ...
            tokenAddress ? someCV(contractPrincipalCV(tokenAddress.split('.')[0], tokenAddress.split('.')[1])) : noneCV(),
            uintCV(tokenAmount),
            uintCV(totalPoints),
            uintCV(startTime),
            uintCV(endTime),
...
export const distributeRewards = async (
    ...
    const txOptions = {
        ...
        functionArgs: [
            uintCV(campaignId),
            tokenContract ? someCV(contractPrincipalCV(tokenContract.split('.')[0], tokenContract.split('.')[1])) : noneCV(),
            distributionList,
        ],
        senderKey,
        validateWithAbi: true,
